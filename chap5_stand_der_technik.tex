...
Aufgeteilt auf 
\begin{itemize}
	\item \textbf{STMCUFinder} um die verwendete Hardware zu bestimmen.
	\item \textbf{STM32CubeMX} zur Konfiguration der Hardware, d.h. Benennung und Funktionszuweisung der Pins, Anpassung von Regiestern, Bestimmung u. Und nach der Konfiguration kann  
\end{itemize}
