...
Dieser Rahmen besteht aus \texttt{main.h} und \texttt{main.c}. 
In dem Header (main.h) befinden sich neben den eingebundenen Headerdateien der Treiber auch die Pindefinitionen, die zuvor konfiguriert wurden.
