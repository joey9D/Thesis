...
\begin{itemize}
	...
	\begin{itemize}
		\item neue Hardware
		\item Softwareentwicklung muss wissen, welche Pins zur Verfügung stehen und wie diese angesteuert werden können $\rightarrow$ welche Chips verwendet werden.
		\item 
	\end{itemize}
	\item Hauptsächlich STM32
	\item Cube Umgebung: Stm32CubeIDE, STM32CubeM
	\item eigene Klassen werden schon verwendet
	\item Programme müssen für jede Hardware neu implementiert werden.
	\item Zukünftiger Einsatz von Zephyr RTOS
\end{itemize}
...
% TODO: Ausgangssituation und Zielsetzung: Rechereche
% Recherche
