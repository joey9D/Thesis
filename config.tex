...
\ihead{} \chead{} \ohead{}
\ifoot{\leftmark} \cfoot{} \ofoot{\pagemark}
...
\lstset{
  ...
  extendedchars=true,
  basicstyle=\footnotesize\ttfamily,
  commentstyle=\color{gray}\ttfamily\slshape,
  ...
  morekeywords={std, cout, cin, cerr, endl, string, vector, map, set} % zusätzliche C++ STL Schlüsselwörter
}
...
%\graphy{bibliography}
\addbibresource{reference.bib} % [datatype=bibtex]
...
\DefineBibliographyStrings{ngerman}{
  ...
  bibliography = {Quellenverzeichnis} %{Literaturverzeichnis}
}
...
\usepackage[acronym, nonumberlist, nopostdot]{glossaries}%indexonlyfirst
\ifdeutsch
