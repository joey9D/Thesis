...
Der \emph{Common Microcontroller Software Interface Standard} ist eine Sammlung von APIs, Softwarekomponenten, Werkzeugen und Arbeitsabläufen.
Es ermöglicht konsistente Softwareschichten und Geräteunterstützung für eine breite Palette von Entwicklungswerkzeugen und Mikrocontrollern. 
In der Sammlung enthalten sind Pakete um den Zugang zu und die Entwicklung mit den Prozessoren erleichtern.
Die einzelnen Pakete liefern Funktionen und Schnittstellen für unterschiedliche Bereiche.
