...
%\begin{itemize}
%	\item erleichtert die Kommunikation über kurze Entfernungen zwischen integrierten Peripherieschaltungen und Mikrocontrollern.
%	\item synchrone serielle Kommunikation
%	\item kann gleichzeitig Daten empfangen und senden
%	\item erleichtert Voll-Duplex, synchrone serielle Kommunikation zwischen einem oder mehreren Slave-Geräten und einem Mikrokontroller
%	\item hauptsächlich genutzt um MCU und Peripherie zu verbinden
%	\item Master: meist MCU, kontrolliert den Datenfluss und generiert ein Taktsignal
%	\item Slave: Peripheriegeräte; vom Master kontrolliert via slave select wann wer kommunizieren will
%	\item SPI Bus: physikalische Verbindung über die der Datenaustausch stattfindet
%	\item 4-wire: Slave/Chip Select, MOSI/COPI, MSIO/CIPO, Serial Clock
%	\item Einfachheit, Hochgeschwindigkeitsfähigkeit und Flexibilität
%	\item Master ist das Gerät, das das Taktsignal generiert
%	\item 
%\end{itemize}
