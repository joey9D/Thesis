...
\label{sec:stm32cube}
\input{chap6_durchfuehrung/chap6_2/stm32.tex}


\subsection{Espressif-IDF}
\label{sec:esp_idf}
\input{chap6_durchfuehrung/chap6_2/esp32.tex}


\subsection{mcu-cpp}
\label{sec:mcu_cpp}
\input{chap6_durchfuehrung/chap6_2/mcu_cpp.tex}
% TODO: chap4 mcu-cpp: Quellen-Verlinkung


\subsection{modm}
\label{sec:modm}
\input{chap6_durchfuehrung/chap6_2/modm.tex}
