...
Damit der SPI Bus getestet werden kann Master via Oszi % siehe AE1 Skript

Damit der UART Bus getestet werden kann via HTerm Datentransfer am PC beobachten.

Damit der CAN Bus getestet werden kann Ixxat Dongel, CAN Mini 
